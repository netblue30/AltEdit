...
// diff first file
#define DIFF1_COLOR Qt::black
#define DIFF1_BACKGROUND_COLOR QColor(200, 200, 200)
#define DIFF2_COLOR Qt::red
#define DIFF2_BACKGROUND_COLOR QColor(200, 200, 200)
...
Highlighter::Highlighter(QTextDocument *parent): QSyntaxHighlighter(parent) {
	...
	diff1Format.setForeground(DIFF1_COLOR);
	diff1Format.setBackground(DIFF1_BACKGROUND_COLOR);
	diff1Format.setFontWeight(QFont::Bold);
	diff2Format.setForeground(DIFF2_COLOR);
	diff2Format.setBackground(DIFF2_BACKGROUND_COLOR);
	diff2Format.setFontWeight(QFont::Bold);
...
//printf("c %d, cpp %d\n", startIndex, cppindex);
	...
	if (text.startsWith("+"))
		setFormat(0, text.length(), diff1Format);
	if (text.startsWith("-"))
		setFormat(0, text.length(), diff2Format);
}
